...
type ListenFunc<K extends WindowEventKeys> = (this: Window, ev: WindowEventMap[K]) => any

export function listen<K extends WindowEventKeys>(...args: [K, ListenFunc<K>]): () => void
