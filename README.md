...
```typescript
import { firstOne, lastOne, stableIndex, createArray } from 'g-utils'
...
```typescript
import { loopFor, reverseFor, reverse } from 'g-utils'
...
```typescript
import { flushFuncs } from 'g-utils'
...
// 也支持Set
const callbackSet = new Set([() => console.log('Set回调1'), () => console.log('Set回调2')])
...
```typescript
import { createCache } from 'g-utils'
...
```typescript
import { createObjCache } from 'g-utils'
...
```typescript
import { iife, memorize, debounce } from 'g-utils'
...
```typescript
import { matchCase, macroMatch } from 'g-utils'
...
```typescript
import { clone, objKeys, useObjectKey } from 'g-utils'
...
```typescript
import { Log, jsonFy, jsonParse } from 'g-utils'
...
```typescript
import { listen, isLeftMouse, isRightMouse, stopPropagation, preventDefault } from 'g-utils'
...
```typescript
import { pow2, pow3, multiply, divide, dCos, dSin, degreeFy, radianFy } from 'g-utils'
...
```typescript
import { rotatePoint, normalAngle, numberHalfFix } from 'g-utils'
...
```typescript
import { xy_, xy_from, xy_client, xy_center } from 'g-utils'
...
```typescript
import { StorageUtil } from 'g-utils'
